...
class Yeeaddons_WPForms_Field_Repeater_Start extends WPForms_Field {
	/**
	 * Pages information.
	 *
	 * @since 1.3.7
	...
	public function init() {
		...
		$this->name  = esc_html__( 'Repeater Start', 'wpforms' );
...
new Yeeaddons_WPForms_Field_Repeater_Start();